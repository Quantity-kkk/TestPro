...
@SupportedAnnotationTypes("com.kyq.test.annotation.classes.ClassAnnotationEx")
public class SelfDefClassAnnotationProcessor extends AbstractProcessor {
    private Filer filer;
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        Set<? extends Element> genElements = roundEnv.getElementsAnnotatedWith(ClassAnnotationEx.class);
        for(Element e: genElements){
            System.out.println(">>> "+e.getSimpleName());
            ClassAnnotationEx gi = e.getAnnotation(ClassAnnotationEx.class);
            ...
            try {
                JavaFileObject jfo = filer
                        .createSourceFile("main.java.com.kyq.test.annotation.classes."+className, e);
