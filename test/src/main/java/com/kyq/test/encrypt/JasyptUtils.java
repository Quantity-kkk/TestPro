...
public class JasyptUtils {
    ...
    public static void main(String[] args) throws Exception {
        String message = "test@.20redis";
        String password = "sx-feeaudit";
        ...
        //解密
        String pwd = stringEncryptor(password, "YCG57GqRbPjOHWE9NdCUSEzAvNbXx2ttI0oLNxxwwecGOa2de9vXDA==", false);
