...
/**
 * Description： “Dark Magic”估算方法，估算线程池的大小
 *
 * @author Will
 */
public abstract class PoolSizeCalculator {
     ...
     * * @param cpu * cpu time consumed by considered task * @param wait * wait time of considered task
     * @param targetUtilization
    ...
    private void calculateOptimalThreadCount(long cpu, long wait, BigDecimal targetUtilization) {
        ...
        System.out.println("Target utilization: " + targetUtilization); System.out.println("Elapsed time (nanos): " + (testtime * 1000000));
        System.out.println("Compute time (nanos): " + cpu); System.out.println("Wait time (nanos): " + wait);
